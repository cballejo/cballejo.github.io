...
output:
  xaringan::moon_reader:
    transition: slide
    css: [default, ./css/fonts_mtheme.css, ./css/theme_IntroR.css]
    lib_dir: libs
    seal: true
    nature:
...
---
background-image: url(https://www.stat.auckland.ac.nz/en/about/news-and-events-5/news/news-2017/2017/12/ross-ihaka-retires/_jcr_content/par/contentblock/par/textimage/image.img.jpg/1517954773376.jpg), url(https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Rober_Gentleman.png/220px-Rober_Gentleman.png)
