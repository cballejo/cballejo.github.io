...
output:
  xaringan::moon_reader:
    css: [default, ./css/fonts_mtheme.css]
    lib_dir: libs
    seal: true
    nature:
...
_**“R es un entorno de software libre para gráficos y computación estadística. Se compila y se ejecuta en una amplia variedad de plataformas UNIX, Windows y MacOS.”**_
