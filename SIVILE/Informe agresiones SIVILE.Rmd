...
agresion |>  filter(establecimiento_nombre %in% establecimientos) |> 
  ...
  labs(title = "Tendencia de casos registrados por provincia", 
...
### Mecanismo según sexo y grupo etario (2022-2023)
...
### Sexo agresor - victima según provincia que reporta al SIVILE (2022-2023)
