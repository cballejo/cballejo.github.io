...
agresiones19 |> 
  ...
  scale_y_continuous(limits = c(0, 6000), breaks = seq(0,6000, by = 500)) + 
  theme(legend.position = "none") +
  labs(title = paste("Agresiones según sexo de la victima - Argentina - n =", sum(agresiones19 |> pull(cant))))
...
agresiones19 |> 
  ...
  labs(title = paste("Agresiones segun provincia - Argentina - n =", sum(agresiones19  |>  pull(cant))))
```
...
agresiones19 |> 
  ...
  labs(title = paste("Tasa de agresiones segun provincia - Argentina - n =", sum(agresiones19  |>  pull(cant))))
```