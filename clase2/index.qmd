...
skimr - tipos de datos

dlookr - describe() - diagnose
dlookr - outlier
duplicados con get_dupes() de janitor

escritura de datos con readr
escritura de datos con
lectura y escritura nativa

medidas resumen - tasas

nuevas variables
condicionales if_else case_when (ejemplificar con grupos etarios)
