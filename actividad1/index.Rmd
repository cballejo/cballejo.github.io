...
background-size: 600px
background-position: 50% 70%
## Método V-fold cross-validation
...
- **workflowset** ofrece también la posibilidad de evaluar modelos con diferentes conjuntos de predcitores automáticamente
...
- **_vf** para remuestras por vfolds
