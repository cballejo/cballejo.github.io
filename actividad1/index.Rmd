...
<br>
.font160[
- Construya el modelo con interacción (*mod_int*) entre sexo (*sex*) y clase (*pclass*).
...
tab_model(mod_sin_int, mod_int, show.aic = T, show.r2 = F)
```
...
$$ln(Odds) = -0.28 - 0.05*30 +1.53*0+0.11*0+2.1*0-0.37*0+2.91*0+2.18*0$$
...
```{r, echo=F, message=F, warning=F, fig.align = 'center', fig.width=8,fig.height=6, fig.asp=0.8}
library(ggeffects)

theme_custom1 <- function(base_size = 14) {
...
ggpredict(mod_int, c("sex", "pclass")) |> 
