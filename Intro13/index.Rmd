---
title: "Gestion de variables de tiempo con R"
subtitle: ""  
author: 
  - "Christian Ballejo"
date: '`r Sys.Date()`'
...
## https: //cballejo.github.io/Intro13
...
- Las fechas y las horas son complicadas porque tienen que reconciliar dos fenómenos físicos (la rotación de la Tierra y su órbita alrededor del sol), con todo un conjunto de fenómenos geopolíticos que incluyen formatos distintos (dd/mm/aaaa - mm/dd/aaaa), los husos horarios y los horarios de verano (en algunas ocasiones).
...
.font150[Capítulo 16 del libro ["R para Ciencias de Datos"](https://es.r4ds.hadley.nz/fechas-y-horas.html)]

---
class:  middle
## Practica 13 - Variables de tiempo
.font150[- Descargamos el [archivo zip](https://drive.google.com/file/d/1RiEtVRGoY1h4UOgOOXGEqyzpYX4LgJUe/view?usp=sharing) de la web

- Descomprimimos la carpeta con el proyecto Tiempo
